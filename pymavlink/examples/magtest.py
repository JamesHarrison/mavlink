...
def set_attitude(rc3, rc4):
    ...
    values[2] = rc3
    values[3] = rc4
    mav1.mav.rc_channels_override_send(
        mav1.target_system,
        mav1.target_component,
        *values)
    mav2.mav.rc_channels_override_send(
        mav2.target_system,
        mav2.target_component,
        *values)
...
mav1.mav.action_send(
    mav1.target_system,
    mav1.target_component,
    MAV_ACTION_CALIBRATE_GYRO)
mav2.mav.action_send(
    mav2.target_system,
    mav2.target_component,
    MAV_ACTION_CALIBRATE_GYRO)
...
mav1.mav.set_mag_offsets_send(
    mav1.target_system,
    mav1.target_component,
    0,
    0,
    0)
mav2.mav.set_mag_offsets_send(
    mav2.target_system,
    mav2.target_component,
    0,
    0,
