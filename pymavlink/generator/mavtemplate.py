...
class MAVTemplate(object):
    ...
    def find_end(self, text, start_token, end_token, ignore_end_token=None):
        ...
        while nesting > 0:
            ...
            # For example, make sure idx2 points to the second '}' in ${{field:
            # ${name}}}
            if ignore_end_token:
                ...
                if text[
                        ...
                        idx2:offset +
                        idx2 +
                        len(combined_token)] == combined_token:
    ...
    def find_rep_end(self, text):
        ...
        return self.find_end(
            text,
            self.start_rep_token,
            self.end_rep_token,
            ignore_end_token=self.end_var_token)
    ...
    def substitute(self, text, subvars={},
        ...
        while True:
            ...
            part1 = text[0:subidx]
            part2 = text[subidx +
                         len(self.start_rep_token):subidx +
                         (endidx -
                          len(self.end_rep_token))]
    ...
    def write(self, file, text, subvars={}, trim_leading_lf=True):
        ...
        file.write(
            self.substitute(
                text,
                subvars=subvars,
                trim_leading_lf=trim_leading_lf))
